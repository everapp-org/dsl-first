...
**Prerequisites**: Familiarity with DDD and code generation *or* interpretation concepts; parser basics help for the grammar-hosted binding (not needed for the data-hosted one)
...
2. **Code is derived** from DSL definitions — generated by meta-programs in a grammar-hosted binding, or interpreted directly from the data in a data-hosted one
